...
followingText model =
  div []
    [ makePar ("Ok, so now that we looked at dairy and you saw that if you consume " ++ toString model.currentVal ++ " pounds of dairy a month, you create " ++ toString (calcTons model.currentVal) ++ " tons of C02 equivalents a year. Now, lets look at chicken to see what kind of impact your poultry consumption has on the environment.")
    ]


{-
  Runs Dialog3.elm, with the slider starting at the value '9'
-}
main =
