...
var _elm_lang$elm_architecture_tutorial$IntroDialog$nonChangeMsg = A2(
	...
	{ctor: '[]'},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('The world is currently facing a global convergence of crises, and perhaps the most well-known crises is that of the environment.'),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
