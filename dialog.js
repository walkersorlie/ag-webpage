...
var _elm_lang$elm_architecture_tutorial$Dialog$calcVal = function (sliderVal) {
	return _elm_lang$elm_architecture_tutorial$Dialog$makePar(
		A2(
			...
			'This is the text here. This number: ',
			A2(
				_elm_lang$core$Basics_ops['++'],
				_elm_lang$core$Basics$toString(5 + sliderVal),
...
var _elm_lang$elm_architecture_tutorial$Dialog$bodyText = function (model) {
	var val = _elm_lang$elm_architecture_tutorial$Dialog$calcVal(model.currentVal);
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Changed text here. Equations to come.'),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
