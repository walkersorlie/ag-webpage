...
var _elm_lang$elm_architecture_tutorial$Dialog2$addSadChicken = A3(_evancz$elm_graphics$Element$image, 210, 210, 'sadChicken.jpeg');
var _elm_lang$elm_architecture_tutorial$Dialog2$chickens = function (model) {
	return (_elm_lang$core$Native_Utils.cmp(model.currentVal, 3) < 0) ? A2(
		...
		{
			ctor: '::',
			_0: _evancz$elm_graphics$Element$toHtml(_elm_lang$elm_architecture_tutorial$Dialog2$addSadChicken),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$p,
		...
		{ctor: '[]'},
		{
			...
			_0: _evancz$elm_graphics$Element$toHtml(
				A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$elm_architecture_tutorial$Dialog2$addSadChicken,
						_1: {
							ctor: '::',
							_0: _elm_lang$elm_architecture_tutorial$Dialog2$addSadChicken,
							_1: {ctor: '[]'}
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$elm_architecture_tutorial$Dialog2$chickens(model),
						_1: {ctor: '[]'}
					}
				}
			}
